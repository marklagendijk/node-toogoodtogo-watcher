...
const MINIMAL_POLLING_INTERVAL = process.env.TOOGOODTOGO_MINIMAL_POLLING_INTERVAL || 15000;
const MINIMAL_AUTHENTICATION_INTERVAL = process.env.TOOGOODTOGO_MINIMAL_AUTHENTICATION_INTERVAL || 3600000;
